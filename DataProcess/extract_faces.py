...
def main():
    ...
    # Videos root directory
    source_dir = '/Users/caozhen/Deepfake-Detection/Datasets'
    # Path to read the videos DataFrame
    videodataset_path = '/Users/caozhen/PycharmProjects/BU-assignment/CS599/Project/data/ffpp_videos.pkl'
    # Path to save the output DataFrame of faces
    facedestination_dir = '/Users/caozhen/PycharmProjects/BU-assignment/CS599/Project/Dataset/image'
    # Path to save the output DataFrame of faces
    facesdataset_path = '/Users/caozhen/PycharmProjects/BU-assignment/CS599/Project/Dataset/image_df/df.pkl'
    # Path to save the temporary per-video outputs
    checkpoint_folder = '/Users/caozhen/PycharmProjects/BU-assignment/CS599/Project/Dataset/checkpoint'
    # Frames per video
    frames_per_video = 10
